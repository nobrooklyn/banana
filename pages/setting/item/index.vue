    ...
    <v-card>
      ...
      <transition name="fade">
        <v-dialog v-model="dialog" max-width="640px" persistent>
          <v-card>
            <v-card-title class="headline grey lighten-2">Item Profile</v-card-title>
            <v-card-text>
      ...
      <v-data-table class="elevation-1 ma-4" :headers="headers" :items="items">
...
export default {
  ...
  methods: {
    ...
    search() {
      this.items = [
        { id: "0001", name: "Car No.1"},
        { id: "1002", name: "Car No.2"},
        { id: "0035", name: "Car No.3"},
        { id: "0109", name: "Car No.4"}
      ];
    },
    cancel() {
      this.dialog = false;
